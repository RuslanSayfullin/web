# сериализация Python обьектов в формат JSON
...
class AnswerSerializer(serializers.ModelSerializer):
    ...
    survey = serializers.SlugRelatedField(queryset=Poll.objects.all(), slug_field='id')
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            raise serializers.ValidationError('Уже ответ существует')
