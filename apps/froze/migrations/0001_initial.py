    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(db_index=True, max_length=40, unique=True, verbose_name='Идентификатор')),
                ...
                ('status', models.CharField(choices=[('new', 'Новый'), ('pay', 'Оплатились')], default='new', max_length=50, verbose_name='Статус')),
